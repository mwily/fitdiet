...
INSERT INTO `category` VALUES ('2', '奶类');
INSERT INTO `category` VALUES ('3', '豆类');
INSERT INTO `category` VALUES ('4', '肉类');
INSERT INTO `category` VALUES ('5', '鱼虾类');
INSERT INTO `category` VALUES ('6', '蛋类');
...
-- Records of customer
-- ----------------------------
INSERT INTO `customer` VALUES ('1', '', '', '男', '1900-02-03', 'lizi', '25d55ad283aa400af464c76d713c07ad', '', '0', '0', '0', '1', '1', '0', '1', '0', '0011010');
INSERT INTO `customer` VALUES ('2', '', '', '男', '1991-10-16', 'haha', '25d55ad283aa400af464c76d713c07ad', '', '0', '1', '1', '0', '1', '0', '0', '0', '1101000');
INSERT INTO `customer` VALUES ('15', '', '', '', null, 'sssddd', '25d55ad283aa400af464c76d713c07ad', '', '1', '1', '1', '1', '1', '1', '1', '1', '11111111');
INSERT INTO `customer` VALUES ('16', '', '', '', null, 'lwq', '202cb962ac59075b964b07152d234b70', '', '1', '1', '1', '1', '1', '1', '1', '1', '11111111');
...
INSERT INTO `favorite` VALUES ('3', '1', '3');
...
CREATE TABLE `food` (
  ...
  `stepToMircrowave` varchar(50) DEFAULT NULL,
  `nutritionValue` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
-- Records of food
-- ----------------------------
INSERT INTO `food` VALUES ('1', '鱼香肉丝', '取1个碗，加入半碗水，依次放入盐，糖，醋，生粉及酱油，调匀备用-其它食材切丝或切末-里脊肉切丝，加入盐，鸡粉胡椒粉生粉加少许水-抓至发粘腌制10分钟-锅中放油烧热后放入肉丝迅速拨散，至颜色变白即关火盛出备用-锅中留底油爆香蒜末及姜末，接着加入豆瓣酱适量炒香-依次放入胡萝卜及茭白丝翻炒至软后，再加入香菇，青椒，最后加入大蒜及肉丝-倒入鱼香汁翻匀即可出锅', 'yxrs.png', '阴虚不足，头晕，贫血，老人燥咳无痰，大便干结，以及营养不良者', '主治热病伤津，消渴赢瘦，身虚体弱，产后血虚，燥咳，便密，滋阴，润燥，润肌肤，利二便和止消渴', '沃尔玛（厦大店）#沃尔玛（火车站店)', null, '20.00', '15', '贝太厨房', '厦大餐饮', '12', null, '补血调理,脾调养调理,肝炎调理,肾调养调理,肝调养调理,学龄前儿童食谱,丰胸调理');
INSERT INTO `food` VALUES ('2', '麻婆豆腐', '尖椒洗净切丁、姜、蒜、葱切末、与豆瓣、油拌匀。豆腐切方丁放入烤碗中-把拌匀的调料放入微波炉中叮一分钟，取出倒在豆腐上，撒上盐、花椒粉、辣椒粉、蒸鱼豉油、蚝油、黄酒、糖、高汤，稍微拌一下，放入微波炉中叮3 分钟', 'mpdf.png', '阴虚不足，头晕，贫血，老人燥咳无痰，大便干结，以及营养不良者', '主治热病伤津，消渴赢瘦，身虚体弱，产后血虚，燥咳，便密，滋阴，润燥，润肌肤，利二便和止消渴', '新华都（厦大店）#沃尔玛（火车站店)', null, '13.00', '12', '贝太厨房', '厦大餐饮', '2', null, '补血调理,脾调养调理,肝炎调理,肾调养调理,肝调养调理,学龄前儿童食谱,丰胸调理');
INSERT INTO `food` VALUES ('3', '老醋花生', '老陈醋中加入绵白糖和盐（1/2茶匙，3g）调成味汁。花生米用清水洗净，沥干水分-取一个适用于微波炉的器皿（不用盖子），放入洗好的花生米，调入剩余的盐（2g）和油，拌均匀。将器皿移入微波炉，以500瓦火力（或中火档）加热3分钟，取出器皿（一定要用布或者专用手套，以免烫伤手），用筷子将器皿中的花生米均匀翻动一下，再次将器皿放入微波炉，以500瓦火力（或中火档）加热2分钟-取出器皿，待花生米完全变凉变脆', 'lchs.png', '阴虚不足，头晕，贫血，老人燥咳无痰，大便干结，以及营养不良者', '主治热病伤津，消渴赢瘦，身虚体弱，产后血虚，燥咳，便密，滋阴，润燥，润肌肤，利二便和止消渴', '沃尔玛（厦大店）#沃尔玛（火车站店)', null, '23.00', '10', '贝太厨房', '厦大餐饮', '3', null, '补血调理,脾调养调理,肝炎调理,肾调养调理,肝调养调理,学龄前儿童食谱,丰胸调理');
INSERT INTO `food` VALUES ('4', '番茄菜花', '菜花去除根部，用小刀切割成小朵，再用清水冲洗干净。番茄洗净，切成小丁- 锅中放入适量热水，大火烧沸后将菜花小朵放入汆煮2分钟，再捞出沥干待用-中火烧热锅中的油，待烧至六成热时将大葱花放入爆香，随后放入番茄酱翻炒片刻，再调入少许清水大火烧沸-将菜花小朵和番茄小丁放入锅中，再调入盐和白砂糖翻炒均匀', 'fqch.png', '阴虚不足，头晕，贫血，老人燥咳无痰，大便干结，以及营养不良者', '主治热病伤津，消渴赢瘦，身虚体弱，产后血虚，燥咳，便密，滋阴，润燥，润肌肤，利二便和止消渴', '沃尔玛（厦大店）#沃尔玛（火车站店)', null, '23.00', '23', '贝太厨房', '厦大餐饮', '55', null, '补血调理,脾调养调理,肝炎调理,肾调养调理,肝调养调理,学龄前儿童食谱,丰胸调理');
INSERT INTO `food` VALUES ('5', '喷香芝麻茄子条', '将长茄子削皮、切成10cm的长条，放入汤碗中加入高汤、老抽、白砂糖、米酒混合拌匀，腌制5分钟。将香葱洗净，切成小葱花，备用-用保鲜膜将装有腌好茄子条的汤碗包好，放入微波炉中，中火加热8分钟-从汤碗中取出茄条，码入 盘子，吃的时候撒上白芝麻和香葱花，即', 'pxzmqzt.png', '阴虚不足，头晕，贫血，老人燥咳无痰，大便干结，以及营养不良者', '主治热病伤津，消渴赢瘦，身虚体弱，产后血虚，燥咳，便密，滋阴，润燥，润肌肤，利二便和止消渴', '沃尔玛（厦大店）#沃尔玛（火车站店)', null, '43.00', '12', '贝太厨房', '厦大餐饮', '321', null, '补血调理,脾调养调理,肝炎调理,肾调养调理,肝调养调理,学龄前儿童食谱,丰胸调理');
...
-- ----------------------------
INSERT INTO `foodmaterial` VALUES ('1', '1', '1', '250克');
INSERT INTO `foodmaterial` VALUES ('2', '1', '2', '150克');
...
INSERT INTO `historyorder` VALUES ('2', '2013-07-29 16:48:35', '30.00', '2', '1', '2');
INSERT INTO `historyorder` VALUES ('3', '2013-07-29 16:48:55', '15.00', '1', '1', '3');
INSERT INTO `historyorder` VALUES ('4', '2013-07-29 16:49:08', '45.00', '2', '1', '5');
INSERT INTO `historyorder` VALUES ('5', '2013-07-29 16:49:30', '45.00', '3', '1', '4');
...
-- ----------------------------
INSERT INTO `initialorder` VALUES ('15', '1', '2', '6');
INSERT INTO `initialorder` VALUES ('16', '1', '3', '11');
INSERT INTO `initialorder` VALUES ('17', '1', '4', '2');
INSERT INTO `initialorder` VALUES ('18', '1', '5', '5');
INSERT INTO `initialorder` VALUES ('20', '1', '1', '28');
